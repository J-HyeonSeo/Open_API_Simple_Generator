...
public interface ApiRequestInviteRepository extends JpaRepository<ApiRequestInvite, Long> {
  ...
  Page<ApiRequestInvite> findByMemberAndApiRequestTypeAndRequestStateType(
      Member member, ApiRequestType requestType, ApiRequestStateType requestStateType, Pageable pageable);

  Page<ApiRequestInvite> findByApiInfoAndApiRequestType(
      ApiInfo apiInfo, ApiRequestType requestType, Pageable pageable);

  Page<ApiRequestInvite> findByApiInfoAndApiRequestTypeAndRequestStateType(
      ApiInfo apiInfo, ApiRequestType requestType, ApiRequestStateType requestStateType, Pageable pageable);
